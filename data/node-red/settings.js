...
module.exports = {
  ...
  adminAuth: {
    ...
    users: [
      ...
      {
        username: 'readonly',
        password: process.env.READONLY_PASSWORD_HASH,
        permissions: 'read',
      },
    ],
  },
  ...
  functionGlobalContext: {
    ...
    telegramBotApiUrlPrefix: process.env.TELEGRAM_BOT_API_URL_PREFIX,
    sendMessagePostfix: 'sendMessage',
    setMyCommandsPostfix: 'setMyCommands',
  },
